        ...
        <div class="content-wrapper">
            <div class="form-section">
                ...
                <form>
                    ...
                    <div class="form-group">
                        <label for="subcategory-image">Sub Category Image URL</label>
                        <input type="url" id="subcategory-image" name="subcategory-image" placeholder="https://example.com/image.jpg">
                    </div>
